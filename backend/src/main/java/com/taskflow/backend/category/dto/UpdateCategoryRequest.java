...
/**
 * Request body for {@code PUT /api/v1/categories/{id}} — see {@code docs/API_SPEC.md} §5.4.
 *
 * <p>A full update: both fields are required and replace the stored values.
 *
 * @param name  category label (required, 1–40 chars, unique per user)
 * @param color 6-digit hex colour, e.g. {@code #0E4A63}
 */
